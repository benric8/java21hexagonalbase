package pe.gob.pj.depositos.infraestructure.db.seguridad;
...
@EnableJpaRepositories(basePackages = "pe.gob.pj.depositos.infraestructure.db.seguridad.repositories",
...
public class SeguridadConfig {
    ...
    LocalContainerEntityManagerFactoryBean seguridadEntityManagerFactory(
        ...
        return builder.dataSource(dataSource)
                .packages("pe.gob.pj.depositos.infraestructure.db.seguridad.entities")
