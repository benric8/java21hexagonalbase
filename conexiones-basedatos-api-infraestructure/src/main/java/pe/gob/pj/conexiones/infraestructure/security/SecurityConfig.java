package pe.gob.pj.conexiones.infraestructure.security;
...
import pe.gob.pj.conexiones.infraestructure.security.adapters.UserDetailsServiceAdapter;
import pe.gob.pj.conexiones.infraestructure.security.filters.JwtAuthenticationFilter;
import pe.gob.pj.conexiones.infraestructure.security.filters.JwtAuthorizationFilter;
...
public class SecurityConfig {
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        log.info("Servicio denominado conexiones-basedatos-ws y tiene los siguientes dominios permitidos {} => {}",
    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.headers(headers -> headers.frameOptions(FrameOptionsConfig::deny))
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/swagger-ui/**", "/v3/api-docs/**", "/swagger-ui.html").permitAll().anyRequest().authenticated()
