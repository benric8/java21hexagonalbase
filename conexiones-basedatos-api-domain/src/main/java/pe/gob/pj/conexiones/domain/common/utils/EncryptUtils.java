package pe.gob.pj.conexiones.domain.common.utils;

import lombok.extern.slf4j.Slf4j;
import pe.gob.pj.conexiones.domain.common.utils.crypt.Base64u;
...
public class EncryptUtils {
    ...
    public static String encryptMd5Hash(String message) {
        try {
            ...
            log.info( "{} Error creating digest MD5 {} ", ex,Level.WARNING);
            return null;
        }
    }
    ...
    public static String encryptSHA512Hash(String message) {
        try {
            ...
            log.info("{} Error creating digest SHA512 {} ", ex,Level.WARNING);
            return null;
        }
    }
    ...
    public static String cryptBase64u(String input, int mode){
        ...
        try {
            ...
            kgen.init(448);
            byte[] raw = defaultKey.getBytes(StandardCharsets.UTF_8);
